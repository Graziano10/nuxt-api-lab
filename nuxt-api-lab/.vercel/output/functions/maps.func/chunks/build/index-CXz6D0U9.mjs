                ...
                return [
                  createVNode('div', { class: 'flex items-center justify-between mb-2' }, [
                    ...
                    createVNode(
                      ...
                      toDisplayString(__props.status),
                      3
                    )
                  ]),
                  createVNode(
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(
        `<section${ssrRenderAttrs(mergeProps({ class: 'space-y-12' }, _attrs))}><header class="space-y-4"><h1 class="text-3xl font-bold tracking-tight" to="/index"> Nuxt API Lab </h1><p class="text-gray-400 max-w-2xl"> Laboratorio pratico per l’integrazione sicura e scalabile di API di terze parti utilizzando Nuxt 4, Vue 3 e Tailwind CSS. </p></header><div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">`
      )
      _push(
        ssrRenderComponent(
          _component_ApiCard,
