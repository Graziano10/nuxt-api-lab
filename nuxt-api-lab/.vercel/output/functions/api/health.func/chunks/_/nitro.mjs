...
const handlers = [
  {
    route: '/api/agro/polygon',
    handler: _lazy_7wBWeQ,
    lazy: true,
    middleware: false,
    method: 'post'
  },
  {
    route: '/api/agro/weather',
    handler: _lazy_lo9MV8,
    lazy: true,
    middleware: false,
    method: 'get'
  },
