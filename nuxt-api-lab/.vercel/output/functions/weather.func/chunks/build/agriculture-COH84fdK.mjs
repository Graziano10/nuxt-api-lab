import { defineComponent, ref, computed, mergeProps, unref, toValue, getCurrentInstance, onServerPrefetch, shallowRef, nextTick, toRef, useSSRContext } from 'vue';
...
function useAgroWeather(params) {
  const { data, pending, error } = useAsyncData(
    ...
    async () => {
      const res = await $fetch("/api/agro/weather", {
        params: {
...
//# sourceMappingURL=agriculture-COH84fdK.mjs.map
